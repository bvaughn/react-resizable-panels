...
export default function SupportRoute() {
  return (
    <Box direction="column" gap={4}>
      ...
      <div>
        <ExternalLink href="https://github.com/bvaughn/react-resizable-panels">
          GitHub
        </ExternalLink>{" "}
      ...
      <div>
        ...
        <ExternalLink href="https://stackoverflow.com/search?q=react-resizable-panels">
          Stack Overflow
        </ExternalLink>{" "}
        or{" "}
        ...
        <ExternalLink href="https://github.com/bvaughn/react-resizable-panels/issues?q=is%3Aissue%20state%3Aclosed">
