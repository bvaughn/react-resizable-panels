...
export function Cell({
  ...
  const { gutters, registerCell, trackCounts } = useGridContext();

  assertValidPlacement("column", column, columnSpan, trackCounts.column);
  assertValidPlacement("row", row, rowSpan, trackCounts.row);
