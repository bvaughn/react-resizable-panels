...
import { updateCursorStyle } from "../global/cursor/updateCursorStyle";
import type { HitRegion } from "../global/dom/calculateHitRegions";
import type { MountedGroupMap } from "../global/mutableState";
...
export function updateActiveHitRegions({
  ...
  // TODO Cache this somewhere for next time
  update({
    cursorFlags,
